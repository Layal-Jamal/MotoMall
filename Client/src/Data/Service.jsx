...
export const ServiceData = [
    {
        title: " Luxury Cars for Your Special Events.",
    ...
    {
        title: " Cars for Companies and Official Events.",
    ...
    {
        title: " Cars for Tourism and Travel.",
    ...
    {
        title: "Cars for Sports Activities and Outdoor Adventures.",
